...
from config import PROJECT_ID, REGION_NAME, GCS_BUCKET_NAME
...
GCP_PROJECT_ID = os.environ.get('GCP_PROJECT', PROJECT_ID)
...
if __name__ == "__main__":
    ...
    os.environ['GCP_PROJECT'] = PROJECT_ID  # Replace with your project ID
